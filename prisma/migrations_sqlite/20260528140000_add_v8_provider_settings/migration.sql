...
CREATE TABLE "UserProviderSetting" (
  ...
  "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updatedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT "UserProviderSetting_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT "UserProviderSetting_providerId_fkey" FOREIGN KEY ("providerId") REFERENCES "PlatformProviderSetting" ("providerId") ON DELETE CASCADE ON UPDATE CASCADE
);
